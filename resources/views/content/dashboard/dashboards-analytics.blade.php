...
<div class="row gy-4 justify-content-center">
    ...
    <div class="col-md-12 col-lg-12">
        <div class="card card-custom shadow-sm">
            <div class="card-header" style="background-color: #8DEAFE;">
                <h5 class="card-title m-0 me-2" style="color: #6c757d;">Medication Reminder</h5>
    ...
    <div class="col-md-12 col-lg-12">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card card-custom shadow-sm">
                    <div class="card-header" style="background-color: #EBFE69;">
            ...
            <div class="col-md-4">
                <div class="card card-custom shadow-sm">
                    <div class="card-header" style="background-color: #9747FF;">
