    ...
    <div class="col-lg-12">
        <div class="card" style="padding: 2rem;">
            ...
            <div class="card-body">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="actionDropdown">
                                                ...
                                                <a class="dropdown-item" href="{{ route('content.admin.foodtrack.edit', $food->id) }}">Edit</a>
                                                <form action="{{ route('content.admin.foodtrack.destroy', $food->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
                ...
                <div class="mb-3">
                            <a href="{{ route('content.admin.foodtrack.create') }}" class="btn btn-primary">
